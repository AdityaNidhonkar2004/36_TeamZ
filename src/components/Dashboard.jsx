...
const Dashboard = () => {
  ...
  const fetchRecentActivity = async () => {
    try {
      const response = await axios.get("https://053e-210-212-183-60.ngrok-free.app/api/errorLogs/top10", { 
  ...
  const fetchErrorStats = async () => {
    try {
      const response = await axios.get("https://053e-210-212-183-60.ngrok-free.app/api/errorLogs/count", { 
        headers: { 'ngrok-skip-browser-warning': 'true' }
      });
